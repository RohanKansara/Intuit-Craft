...
insert into buyer (id, name, certified_buyer) values (6, 'TRGF', false);
insert into buyer (id, name, certified_buyer) values (7, 'FDFD', false);
insert into buyer (id, name, certified_buyer) values (8, 'FDF33D', false);
insert into buyer (id, name, certified_buyer) values (9, 'EWD', false);
insert into buyer (id, name, certified_buyer) values (10, 'GV@13', false);
